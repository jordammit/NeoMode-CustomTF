...
extern int team_no_offset;
extern float minprozac;
// Structure holding startup time and date in its fields - September 2020
typedef struct 
{
	int hour;
	int minute;
...
extern startup_timedata_t startup_time;

void SV_RetrieveClientVersion(client_t* theclient);
ddef_t *ED_FindField(char *name);
extern char CurrentIntegrationStr[512]; // char CurrentIntegrationStr[512]; <-- was January 2022
...
// DO NOT USE '32768' It's used by quakeC - FL_MACHINE
#define FL_SKIPLANDSAMPLE       65536 // OfN - Skips demon land sample playing for this ent
#define FL_FLYNOCLIP            131072 // OfN - For engineer railgun projectiles, no clip or sliding on walls
#define FL_UWATERPUSHED       262144 // December 2021
...
// OfN
#define MULTICAST_PROZAC        8
#define MULTICAST_NON_PROZAC   16
...
extern cvar_t pm_deadfix; // December 2021
...
extern cvar_t sv_showheartbeats; // OfN
...
// sv_init.c
extern qbool rcon_from_user;           // current command is a from a user
...
extern Progs_StrBufferItem ProgsStringsBuffer[MAX_BUFFER_STRINGS]; //Progs_StrBufferItem ProgsStringsBuffer[MAX_BUFFER_STRINGS]; < --was January 2022

extern unsigned int NumStrBuffersUsed; // unsigned int NumStrBuffersUsed; < --was January 2022

char* GetNewStringBuffer();
void CheckUnusedStrBuffers(); // pr_cmds.c
void ResetStrBuffers(); // pr_cmds.c - used on sv_init.c
dfunction_t* PR_GetReturningFunction(); // pr_exec.c

// Permanent strings stuff
#define MAX_PERM_STRING_LEN 128 // March 2022 - was 32
...
extern Progs_PermStringItem ProgsPermString[MAX_PERM_STRINGS]; // <-- Progs_PermStringItem ProgsPermString[MAX_PERM_STRINGS]; Was January 2022
